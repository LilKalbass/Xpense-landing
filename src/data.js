...
export const nav = [
  { name: 'Features', href: '/', idTO: '_features'},
  { name: 'About us', href: '/', idTO: '_about'},
  { name: 'Pricing', href: '/', idTO: '_pricing'},
  { name: 'Feedback', href: '/', idTO: '_feedback'},
];
...
export const footer = {
  ...
  links: [
    ...
    { name: 'About us', href: '/', idTO: '_about'},
    { name: 'Careers', href: '/' , idTO: '_careers'},
    { name: 'Pricing', href: '/', idTO: '_pricing'},
    { name: 'Features', href: '/', idTO: '_features'},
    { name: 'Blog', href: '/' , idTO: '_blog'},
  ],
  legal: [
